...
{ 
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string receiver; string mailbody ="";
            string subj;
        ...
        EmailAccount BuildEmailaccount(int type, string username, string password, string smtp = "smtp.live.com", int port = 587, bool isSSL = false){
            EmailAccount myacc = new EmailAccount();
            switch (type) {
                case 1: 
